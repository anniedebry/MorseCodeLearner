...
class PanelTest
{
	private MorseController testedController; //Change me
	private MorsePanel testedPanel; //Change me

	@BeforeEach
	void setUp() throws Exception
	{
		this.testedController = new MorseController(); //Change me
		this.testedPanel = new MorsePanel(testedController); //Change me
	} 
